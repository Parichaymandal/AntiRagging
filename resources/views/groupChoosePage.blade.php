...
<head>
    ...
    <title>Choose Group Page</title>

    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="css/page_component_css/navbar_style.css">
    <link rel="stylesheet" type="text/css" href="css/group-choose-page-style.css">
...
<!-- Group choose button area starts -->

<div class="container-fluid groupButtonArea">

    <div class="row">
        <div class="col-md-12">
            <div class="col-md-4 center-btn">
                <a href="\group" class="btn btn-lg btn-info">Approved Group</a>
            </div>
            <div class="col-md-4 center-btn">
                <a href="\pending" class="btn btn-lg btn-info">Pending Group</a>
            </div>
            <div class="col-md-4 center-btn">
                <a href="\group_search" class="btn btn-lg btn-info">Search Group</a>
            </div>
        </div>
    </div>
...
<script src="js/group_choose_page_js.js"></script>
</body>
</html>