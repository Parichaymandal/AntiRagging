    ...
    <div class="container-fluid total-group">
        ...
        <div class="group-container">
            ...
            <div class="row group-style">
                <div class="col-md-12">
                    <h1>Name: {!! $r->requested_by->name !!}</h1>
                    <hr>
                    <p>Discipline: {!! $r->requested_by->discipline !!}</p>
                    <p>University: {!! $r->requested_by->university !!}</p>
                </div>

                {!! Form::open(['url'=>['accept',$r->id],'method'=>'GET']) !!}
                    <div>
                ...
                {!! Form::open(['route'=>['group_control.destroy',$r->id],'method'=>'DELETE']) !!}
                    <div>
